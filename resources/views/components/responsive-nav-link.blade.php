...
$classes = ($active ?? false)
            ? 'block w-full pl-3 pr-4 py-2 border-l-4 border-hs-blue-400 text-left text-base font-medium text-hs-blue-700 bg-hs-blue-50 focus:outline-none focus:text-hs-blue-800 focus:bg-hs-blue-100 focus:border-hs-blue-700 transition duration-150 ease-in-out'
